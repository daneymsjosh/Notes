                ...
                <div>
                    <p class="text-sm mt-2 text-dark-800 dark:text-dark-200">
                        ...
                        <button form="send-verification"
                            class="underline text-sm text-dark-600 dark:text-dark-400 hover:text-dark-900 dark:hover:text-dark-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-dark-800">
